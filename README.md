...
| `XPTracker.mpackage` | GMCP XP tracker. Gives pretty overview of what xp you gained this session. More of the data can be shown if wanted. WILL NOT WORK IF INSTALLED MIDSESSION. REQUIRES GMCP INFO THAT IS ONLY PASSED AT LOGIN. INSTALL FIRST, THEN LOGIN TO MUME.|
